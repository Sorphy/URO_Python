...
class RecipesFrame(Frame):
    def __init__(self, master):
        ...
        self._recipe_list.column('#2', anchor=CENTER, width=112)
        self._recipe_list.heading('#3', text='TO', anchor=CENTER)
        self._recipe_list.column('#3', anchor=CENTER, width=113)
        ...
        self._type_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
        self._code_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
        self._name_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
        self._dosage_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
        self._from_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
        self._to_entry = Label(self._recipe_detail_frame, bg='#EEEEEE', state='disabled', relief=FLAT, width=20)
    ...
    def fill_list(self, patient):
        ...
        for recipe in patient.data['recipes']:
            self._recipe_list.insert("", END, text=temp, values=(recipe.data['name'], recipe.data['from'], recipe.data['to']))
            temp += 1
